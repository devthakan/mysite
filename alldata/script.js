...
// === एडमिन सर्च फंक्शन (HTML बनाने वाला) ===
async function handleAdminSearch(e) {
    ...
    data.forEach(item => {
        ...
        // BUG FIX: आधार नंबर अब एडिटेबल नहीं है, और Save बटन के कोड से भी हटा दिया गया है
        card.innerHTML = `
...
// === अपडेट फंक्शन (BUG FIXED) ===
async function updateRecord(aadhaarNumber) {
    // BUG FIX: आधार नंबर को अपडेट नहीं कर रहे हैं क्योंकि वह प्राइमरी की है
    const updates = {
